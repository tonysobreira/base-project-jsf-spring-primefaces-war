...
$(document).ready(function() {
    ...
    $("#compartilhamento").on("click",function(){
		$("#globalCompartilhamento").slideDown(300);
	})
    .on("mouseleave",function(){
		$("#globalCompartilhamento").slideUp(1);
	});
    
    // abrir mensagens
    $("#mensagem").on("click",function(){
		$("#globalMensagem").slideDown(300);
	})
    .on("mouseleave",function(){
		$("#globalMensagem").slideUp(1);
	});
    
    // abrir notificações
    $("#notificacao").on("click",function(){
		$("#globalNotificacao").slideDown(300);
	})
    .on("mouseleave",function(){
		$("#globalNotificacao").slideUp(1);
	});
    
    // abrir opções
    $("#opcoes").on("click",function(){
		$("#globalOpcoes").slideDown(300);
	})
    .on("mouseleave",function(){
		$("#globalOpcoes").slideUp(1);
	});
    
    // abrir página compartilhamento usuários
    $("#compartilhamento").on("click",function(){
